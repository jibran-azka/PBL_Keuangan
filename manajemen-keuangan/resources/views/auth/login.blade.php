        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <div class="flex items-center">
                @if (Route::has('register'))
                    <a class="mr-4 text-sm text-gray-600 underline rounded-md dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
                        {{ __('Register') }}
                    </a>
                @endif
